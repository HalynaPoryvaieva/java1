...
public class MathOperations {
    public static void main(String[] args) {
        ...
        // сложение
        result = var1 + var2; // результат вычислений выражения в правой части присваивается в переменную в левой част присвоения
        System.out.println("result " + result);
        result = 15 + 6;
        System.out.println("result " + result);
        int result2 = var1 + var2; // объявление и инициализация результатом вычисления
