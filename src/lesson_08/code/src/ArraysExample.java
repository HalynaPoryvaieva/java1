...
public class ArraysExample {
    public static void main(String[] args) {
        ...
        System.out.println("В ячейке под номер 2 в массиве strings1 хранится: " + strings1[2].toUpperCase());
        System.out.println("В ячейке под номер 3 в массиве digits хранится: " + digits[3]);
